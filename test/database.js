const short_words = [
	"klub", "rok", "sok", "bok", "krój", "strój", "bicz", "woda", "gad", "ssak",
    "tren", "czas", "kok", "grab", "lin", "baza", "runy", "rak", "lew", "lot",
    "gust", "fart", "żel", "krem", "kiść", "sen", "noc", "kit", "słój", "moc",
    "foka", "mysz", "koń", "lek", "kleń", "hak", "stan", "plan", "krew", "żyła",
    "tlen", "azot", "hel", "stal", "dysk", "test", "wór", "mors", "lew", "pan",
    "pani", "kość", "maj", "luty", "post", "dar", "tors", "dron", "ręka", "ból",
    "żaba", "lipa", "kort", "piła", "kosa", "tor", "ład", "mus", "haft", "klej",
    "byk", "siła", "port", "sort", "bat", "ster", "fugi", "jaź", "płoć", "krąp",
    "łódź", "wieś", "sos", "kij", "dzik", "tusz", "huk", "ryk", "buk", "grab",
    "liść", "koło", "rama", "kler", "keks", "nos", "brak", "prąd", "takt", "nie"
];
